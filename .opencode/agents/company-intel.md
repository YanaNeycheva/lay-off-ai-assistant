---
description: >-
  (Optional) Evaluates a specific job posting and preps company-specific interview intel — fit
...
2. Fetch the posting (web fetch) and research the company (web search): what they do, recent news, the team/role context.
